...
//-----------------------------------------------------------------------------	
	...
	TBranch *b_Total_Events = t2->GetBranch("Total_Events");
	...
	// loop tree entries t2
	Long64_t nbytes = 0, nb = 0, i=0;
	for (Long64_t kentry2=0; kentry2<nentries2;kentry2++) 
	{
		...
		//For counters (Intergers)
		b_Total_Events->GetEntry(ientry2);
		
		count_Total_Events_data =+ Total_Events;
	...
	cout << "Total Events: "<< count_Total_Events_data << endl;	
