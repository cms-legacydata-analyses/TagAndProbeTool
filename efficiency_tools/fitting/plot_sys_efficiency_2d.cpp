...
#include "src/yields_n_errs_to_TH2Ds.cpp"
...
void plot_sys_efficiency_2d()
{
	...
	TH2D *hist_all           = create_TH2D("all_systematic",  "All Systematic",  xquantity, yquantity, nbinsx, nbinsy, xbins, ybins);
	...
	TH2D *hist_pass          = create_TH2D("pass_systematic", "Pass Systematic", xquantity, yquantity, nbinsx, nbinsy, xbins, ybins);
	...
	for (int i = 0; i < nbinsx; i++)
	{
		for (int j = 0; j < nbinsy; j++)
		{
			...
			yields_n_errs_to_TH2Ds(hist_all_nominal, hist_pass_nominal, i+1, j+1, yields_n_errs);
			...
			yields_n_errs_systematic[2] += pow(yields_n_errs[2], 2);
			yields_n_errs_systematic[3] += pow(yields_n_errs[3], 2);
			yields_n_errs_to_TH2Ds(hist_all_2gauss, hist_pass_2gauss, i+1, j+1, yields_n_errs);
			...
			yields_n_errs_systematic[2] += pow(yields_n_errs[2], 2);
			yields_n_errs_systematic[3] += pow(yields_n_errs[3], 2);
			yields_n_errs_to_TH2Ds(hist_all_massup, hist_pass_massup, i+1, j+1, yields_n_errs);
			...
			yields_n_errs_systematic[2] += pow(yields_n_errs[2], 2);
			yields_n_errs_systematic[3] += pow(yields_n_errs[3], 2);
			yields_n_errs_to_TH2Ds(hist_all_massdown, hist_pass_massdown, i+1, j+1, yields_n_errs);
			...
			yields_n_errs_systematic[2] += pow(yields_n_errs[2], 2);
			yields_n_errs_systematic[3] += pow(yields_n_errs[3], 2);
			yields_n_errs_to_TH2Ds(hist_all_binup, hist_pass_binup, i+1, j+1, yields_n_errs);
			...
			yields_n_errs_systematic[2] += pow(yields_n_errs[2], 2);
			yields_n_errs_systematic[3] += pow(yields_n_errs[3], 2);
			yields_n_errs_to_TH2Ds(hist_all_bindown, hist_pass_bindown, i+1, j+1, yields_n_errs);
			...
			yields_n_errs_to_TH2Ds(hist_all, hist_pass, i+1, j+1, yields_n_errs);
	...
	generatedFile->   cd("/");
	get_efficiency_2D(hist_all_nominal,  hist_pass_nominal,  xquantity, yquantity, MuonId, "Nominal",  true);
	get_efficiency_2D(hist_all_2gauss,   hist_pass_2gauss,   xquantity, yquantity, MuonId, "2xGauss",  true);
	get_efficiency_2D(hist_all_massup,   hist_pass_massup,   xquantity, yquantity, MuonId, "MassUp",   true);
	get_efficiency_2D(hist_all_massdown, hist_pass_massdown, xquantity, yquantity, MuonId, "MassDown", true);
	get_efficiency_2D(hist_all_binup,    hist_pass_binup,    xquantity, yquantity, MuonId, "BinUp",    true);
	get_efficiency_2D(hist_all_bindown,  hist_pass_bindown,  xquantity, yquantity, MuonId, "BinDown",  true);
