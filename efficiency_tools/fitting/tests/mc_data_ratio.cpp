...
void mc_data_ratio()
{
	...
	TFile* file0 = TFile::Open(string("../results/efficiencies/systematic_2D/Jpsi_MC_2020/Eta_Pt_" +MuonId+".root").c_str());
	TFile* file1 = TFile::Open(string("../results/efficiencies/systematic_2D/Jpsi_Run_2011/Eta_Pt_"+MuonId+".root").c_str());
	...
	heff->SetTitle(string("MC/Data for " + MuonId + " (" + sufix + ")").c_str());
	...
	if (should_save)
	{
		string output_folder_name = "../results/tests/mc_data_ratio/";
